...
It was built with the help of AI (chatgpt 5.2 and 5.1Mini, Grok 4 and 4.1, Gemini 3 and 3.1 Pro). It works right now as stated below, but the code is a mess(for now) on purpose.
